...
<html>
<head>
<title>Your WordPress Made Simple Email Whitelist Instructions</title>

<meta name="description" content="Whitelist Your WordPress Made Simple to be sure you get the email you requested...">

<meta property="og:title" content="Your WordPress Made Simple Email Whitelist Instructions">
...
<body>
<div class="main">
<h1>Your WordPress Made Simple&nbsp;Email Whitelist Instructions</h1>
...
<p>
If you do not see an email from <strong>Wayne Hatter</strong> in your Inbox, my email may have mistakenly been sent to your spam folder.
</p>

<p>
Please <strong>open your spam folder</strong> and if you find an email from <strong>Wayne Hatter</strong> open it</strong> and mark it as <strong>"Not spam"</strong>...
</p>

<p>
<u>NEXT</u>: Click your provider below to Whitelist <strong>wayne@yourwpmadesimple.com</strong>
</p>
...
<p>If <strong>Wayne Hatter</strong> is being filtered, try adding <strong>wayne@yourwpmadesimple.com</strong> to your Address Book or Contact list. 

<p>If messages continue to be sent to your junk folder contact your ISP or spam filter application support and ask how to whitelist <strong>wayne@yourwpmadesimple.com</strong></p>
...
<p>If you do not readily find an email from <strong>Wayne Hatter</strong></p>
...
<ol>
	<li>If you find an email from <strong>Wayne Hatter</strong> in Gmail spam? </li>
...
<p>Now you will always see <strong>Wayne Hatter</strong> in your Primary Inbox tab!</li>

<p>Next, if the email remains open? Please mark the email as "Not spam"</p>

<ol>
	<li> - If you see an email from <strong> Wayne Hatter</strong>: Open the email please.</li>
...
<p>Next please, add Wayne Hatter to your Contacts list:</p> 
...
<p style="font-family: roboto; font-weight: bold;">(2 minutes ago)</span> <img src="https://s3.amazonaws.com/wlist-images/gmail-dropdown.png" /></p>
	...
	<tr>
	<td style="background-color: #EEEEEE;">
	<p>&nbsp; Add Wayne Hatter to Contacts list &nbsp; </p>
	</td>
	</tr>
...
<ol>
	<li> - Open the email from <strong>Wayne Hatter</strong>.</li>
	<li> - Click the drop down arrow next to "Reply" in the upper right side the email from header.</li>
	<li> - Click the "Add <strong> Wayne Hatter</strong> to Contacts List" from the list that appears.</li>
	<li> - If <strong>Wayne Hatter</strong> does not appear in the dropdown list? Then you probably have already added <strong>Wayne Hatter</strong> to Contacts.</li>
</ol>
...
<ol>
	<li> - If you find an email from <strong>Wayne Hatter</strong> in your Gmail Promotions tab:</li>
	...
	<div style="background-color: #202124; border: #202124 1px solid; border-radius: 5px;">
 	<p style="color: #ffffff; padding-left: 10px;">Conversation moved to Primary. Do this for future messages from wayne@yourwpmadesimple.com?</p>
	...
	<li> - This way you will always see <strong>Wayne Hatter</strong> in your Primary Inbox tab...</li>
</ol>
...
<p>Should you not readily see an email from <strong>Wayne Hatter</strong>, please check the Spam Folder:</p>

<p>Should an email from <strong>Wayne Hatter appear mistakenly</strong> sent to Gmail spam?</p>
...
<ol>
	<li>When you find the email from <strong>Wayne Hatter</strong></li>
...
<p>This should help Gmail to know, you always want to see <strong>Wayne Hatter</strong> in your Primary Inbox tab...</p>
...
<h4>If you do not see an email</strong> from <strong>Wayne Hatter</strong> in your Inbox...</h4>

<p>Check your Spam Folder. If an email from <strong>Wayne Hatter</strong> is there?</p>
...
<p>To ensure delivery: Create a filter to automatically send email from <strong>Wayne Hatter</strong> to your Inbox.</p>
...
<ol>
	...
	<li> - Enter our email address <strong>wayne@yourwpmadesimple.com</strong> in the text box next to <strong>Contains...</strong></li>
	...
	<li> - You will see in the next screen -Deliver to <strong>Inbox</strong> if From contains <strong>Wayne Hatter</strong>-</li>
...
<p>To indicate that an email message from <strong>Wayne Hatter</strong> isn�t junk:</p>
...
<ol>
	...
	<li> - Find the email from <strong>Wayne Hatter</strong> and slide it left to see options.</li>
	<br/>
...
<p>The message is moved to your Inbox. Subsequent email messages from <strong>Wayne Hatter</strong> will no longer be marked as junk.</p>
...
<p> - To add <strong>Wayne Hatter</strong> to your list of <strong>Focused Inbox</strong> on the Outlook App...</p>

<p>Please open the mobile Outlook app on your Android, Microsoft or iPhone:</p>

<p>Then open the email from <strong>Wayne Hatter</strong>:</p>
...
<ol>
	...
	<li>Now all future messages from <strong>Wayne Hatter</strong> will appear in your <strong>Focused Inbox</strong></li>
</ol>
...
<p>Please add <strong>Wayne Hatter</strong> to your list of "Safe senders" on Outlook:</p>
...
<ol>
	<li> - Check the <strong>Junk</strong> folder. If you see the <strong>Wayne Hatter</strong> email in your Inbox</li>
	<li> - Open the email from <strong>Wayne Hatter</strong>...</li>
	...
	<div>
	<hr/>
	<p>Wayne Hatter  (wayne@yourwpmadesimple.com)
...
<ol>
	...
	<li> - Enter the email address <strong>wayne@yourwpmadesimple.com</strong> in the text box.</li>
	<li> - Click <strong>Add to list</strong></li>
	<li> - <strong> Wayne Hatter</strong> will now be added to your list of <strong>Safe senders</strong></li>
...
<p>If you find <strong>Wayne Hatter</strong> in your spam folder:</p>
...
<p>Add <strong>wayne@yourwpmadesimple.com</strong> to your Address Book:</p>

<ol>
	<li> - Open the email from <strong>Wayne Hatter</strong></li>
	<li> - Click the <strong>show details</strong> link next to <strong>Wayne Hatter</strong> in the From field.</li>
	<li> - Move your mouse over or tap <strong>wayne@yourwpmadesimple.com</strong> to show the menu.</li>
	<li> - Click or tap <strong>Add contact</strong> in the menu displayed.</li>
	<li> - Add <strong>Wayne Hatter</strong> to the name fields</li>
...
<ol>
	...
	<li> - Open the email from <strong>Wayne Hatter</strong> please.</li>
...
<ol>
	<li>Should you find an email from <strong>Wayne Hatter</strong> in your spam folder:</li>
	<li>Open the email.</li>
...
<p>Next please, add <strong>Wayne Hatter</strong> to your address book:</p> 

<ol>
	<li> - Please open the email from <strong>Wayne Hatter</strong>.</li>
...
<li> - Add <strong>Wayne Hatter</strong>  to your address book.</li>
</ol>
...
<ol>
<li> - While in the <strong>Suspect Email</strong> folder, if you see <strong> Wayne Hatter</strong>...</li>
<li> - Select the <strong>Move to Inbox and Add Contact</strong> option from the drop down menu.</li>
<li> - This will add <strong>wayne@yourwpmadesimple.com</strong> to your Address Book for future email delivery assurance.</li>
</ol>
...
<li> - Fill in <strong>wayne@yourwpmadesimple.com</strong> as the email address of the sender.</li>
...
<p>If an email from <strong>Wayne Hatter</strong> appears in your Junk Folder:</p>
...
<li> - Under the <strong>Contact tab</strong>, copy and paste the "From" address, <strong>wayne@yourwpmadesimple.com</strong> into the email text box.</li> 
<li> - Click <strong>OK</strong>.</li>
</ol>
...
<p>This problem may occur if <strong>wayne@yourwpmadesimple.com</strong> is accidentally added to the Blocked List.</p>

<p>To remove the <strong>wayne@yourwpmadesimple.com</strong> from the Blocked List:</p>
...
<ol>
	...
	<li> - If you do not find <strong>wayne@yourwpmadesimple.com</strong> in the Blocked list, go to next step.</li>
</ol>

<p><strong>To add wayne@yourwpmadesimple.com to the Allowed List:</strong></p>
...
<ol>
	...
	<li> - Add <strong>wayne@yourwpmadesimple.com</strong>, and then click OK.</li>
...
<ol>
	<li>In order to add <strong>Wayne Hatter</strong> to the friends whitelist, please open McAfee and click on <strong>Web & Email Protection</strong>.</li>
	...
	<li> - Please add <strong>wayne@yourwpmadesimple.com</strong> to your "Friends List" to always allow emails from <strong>Wayne Hatter</strong>.</li>
</ol>
...
<h4>If you received an email message from Wayne Hatter that was incorrectly moved to the Spam Mail folder by the Anti-Spam Toolbar you can prevent this from occurring in the future</h4>
...
<ol>
	<li> - Add the <strong>Wayne Hatter</strong> to the list of Approved Senders.</li>
...
<li> - Type: <strong>wayne@yourwpmadesimple.com</strong></li> 
<li> - Click OK.</li>
<li> - Click OK.</li>
<li> - Click Yes.</li>
<li> - Click OK.</li>
...
<li> - If you find an email from <strong>Wayne Hatter</strong> or an email from <strong>wayne@yourwpmadesimple.com</strong> in @SaneLater...</li>
...
<ol>
	...
	<li> - <strong>whitelist_from wayne@yourwpmadesimple.com</strong></li>
...
<li> - 
Locate the email from <strong> Wayne Hatter</strong> and the sender email address <strong>wayne@yourwpmadesimple.com</strong> that you do not want quarantined in the future. Click on the word "Whitelist," which is in green print to the right of the email title. This will open your list in a web browser.
</li>
...
<ol>
	...
	<li> - Choose "Sender Domain Block/Accept." Enter the Domain name from <strong>wayne@yourwpmadesimple.com</strong> to whitelist. For example, you can enter aol.com to allow all AOL addresses.</li>

	<li> - You may enter a comment to remind you why you allowed this Domain. Click "Add."</li>

	<li> - Click your mouse on the "Email Sender Block/Accept" tab. Enter the email address of an individual sender that you want to whitelist, such as "<strong>wayne@yourwpmadesimple.com</strong>"</li>
...
<p>Highlight the email from <strong>Wayne Hatter</strong> with the email address <strong>wayne@yourwpmadesimple.com</strong> to Whitelist.</p>

<p>Click "More" in the SPAMfighter Toolbar and select "Whitelist".</p> 

<p>Here you can choose if you want to Whitelist the email address <strong>wayne@yourwpmadesimple.com</strong> or the whole Domain.</p>
...
<li> - Type in the sender email address <strong>wayne@yourwpmadesimple.com</strong></li>
...
<li> - Type: <strong>wayne@yourwpmadesimple.com</strong> on a line by itself in the entry field.</li>
<li> - Click OK.</li>
</ol>

<p>Wayne Hatter is in no way associated with any of the brands, websites or applications quoted here. All Trademarks &reg; are the property of their respective owners.</p>
